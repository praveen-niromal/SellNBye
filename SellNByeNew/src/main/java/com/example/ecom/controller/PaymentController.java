...
public class PaymentController {
    ...
    public ApiResponse pay(@RequestParam(value = "quantity") int quantity, @RequestParam(value = "address") String address, @RequestParam(value = "card_type") String card_type, @RequestParam(value = "card_number") String card_number, @RequestParam(value = "cvs") String cvs, @PathVariable("productID") Long productID) {

        int status = paymentService.buy(productID,quantity);
        ...
        if(status == 0){
            ...
            Shipment shipment = shippingService.shipProduct(address);
